                ...
                <ul class="flex space-x-4">
                    <li
                        ...
                        <div v-if="profile"
                            ...
                            <p class="text-sm text-gray-500 mt-1">{{ storedUser.username }}</p>

                            <hr class="border-b-0 my-4" />

                            <button type='button' @click="handleLogout"
                                class="bg-transparent border border-gray-300 hover:border-pink-500 px-4 py-2 mt-4 text-sm text-pink-500 font-semibold">LOGOUT</button>
                        </div>
                    </li>
                    ...
                    <li
                        ...
                        <div class="flex flex-col justify-center items-center cursor-pointer">
                            ...
                            <span class="text-xs font-semibold mt-1"><a href="/cart">Bag</a></span>
                        </div>
                    </li>
                </ul>
...
export default {
    ...
    setup() {
        ...
        const handleLogout = async () => {
            try {
                await logout(cookieToken.value)
