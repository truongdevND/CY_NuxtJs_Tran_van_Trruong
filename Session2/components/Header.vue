<template>
  <div class=" sticky z-40 top-0 w-full">
    <header
      class="flex shadow-lg py-4 px-4 sm:px-10 bg-white opacity-[0.9] font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
      <div class="w-full flex flex-wrap items-center lg:gap-y-4 gap-y-6 gap-x-4">
        <a class="text-[30px] font-bold" href="/home">SHOPPINGER </a>
        ...
        <div class="flex items-center ml-auto">
          <ul class="flex space-x-4">
            ...
            <li
              ...
              <p class="text-xl font-bold text-black absolute w-7 h-7 text-center top-[-5px] right-[-10px]">
