<template>
  <div
    class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b  from-gray-50 to-gray-400"
  >
    <div class="opacity-[0.7] max-w-md w-full">
      <form
        @submit.prevent="handleSubmit"
        class="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-8"
      >
